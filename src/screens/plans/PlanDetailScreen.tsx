...
function createStyles(colors: ThemeColors) {
  ...
  routeMetricValue: { color: colors.primaryText, fontSize: typography.heading, fontWeight: '900' },
  ...
  stopTime: { color: colors.primaryText, fontSize: typography.caption, fontWeight: '900' },
